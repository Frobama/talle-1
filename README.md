...
```
cd existing_repo
git remote add origin https://gitlab.com/benjamin.rojas.espejo/taller-1.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/benjamin.rojas.espejo/taller-1/-/settings/integrations)
